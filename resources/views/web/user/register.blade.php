...
<head>
    ...
    <title>Pavakikademy | User Register</title>
...
<body class="gray-bg">
    ...
    <div class="middle-box text-center loginscreen   animated fadeInDown">
        <div>
            ...
            <form class="m-t" role="form" action="{{route('web.register')}}" autocomplete="off" method="POST">
                @csrf
                ...
                <div class="form-group">
               <input type="number" min="0" name="mobile_no" placeholder ="phone-no" value="{{ old('mobile_no') }}" required />
               </div>
